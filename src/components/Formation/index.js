    ...
    return(
      <>
        ...
        <section class="formation">
          <div class="chronologie">
            <div class="dot">
              <div class="block"> 
                ...
                <img src="/Users/alexma/Sites/projets/portfolio/logos/oclock.png" class="logoFormation"/>
                <div class="details">
                  ...
                  <p class="formationDescription">Tronc commun :<br>
                    ...
                    MVC | Back Office | AJAX, API | CM<br><br>
            ...
            <div class="dot">
              <div class="block">
                <div class="triangle"></div>
                <img src="/Users/alexma/Sites/projets/portfolio/logos/opquast.png" class="logoFormation"/>
                <div class="details">
                  <h5 class="formationTitle">Certificat Opquast N° CNX2FA</h5>
                  <h5 class="formationTitle">Opquast (2021-26)</h5>
                  <p class="formationDescription">Maîtrise de la qualité en projet Web | <br>Score : <em>855 points sur 1000</em>
                  </p>
            ...
            <div class="dot">
              <div class="block">
                <div class="triangle"></div>
                <img src="/Users/alexma/Sites/projets/portfolio/logos/lesGobelins.png" class="logoFormation"/>
                <div class="details">
                  ...
                  <p class="formationDescription">Contenu principal :<br>
                    ...
                    Méthodologie, personas, idéation,<br>ergonomie, prototypage<br><br>
                  </p>
                </div>                
              </div>
            </div>
          ...
          <img src="/Users/alexma/Sites/projets/portfolio/illustrations/undraw/undraw_Project_completed_re_pqqq.svg" alt="" class="aknowledgment"/>    
        </section>
